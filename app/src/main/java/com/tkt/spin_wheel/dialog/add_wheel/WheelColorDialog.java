...
public class WheelColorDialog extends BaseDialog<DialogAddWheelColorBinding> {
    ...
    protected void initView() {
        WheelModel standard = AppDatabase.getInstance(getContext()).wheelDAO().findByName("Standar_d__");
        ...
        WheelModel sixColor = AppDatabase.getInstance(getContext()).wheelDAO().findByName("Six_Colo_r_");
        ...
        WheelModel vintage = AppDatabase.getInstance(getContext()).wheelDAO().findByName("Vintag_e__");
        ...
        WheelModel twoColor = AppDatabase.getInstance(getContext()).wheelDAO().findByName("Two_Colo_r_");
        ...
        WheelModel pastel = AppDatabase.getInstance(getContext()).wheelDAO().findByName("Paste_l__");
